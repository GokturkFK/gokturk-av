...
| 11 | Debug Portları (JTAG/UART) (`debug_ports`) | Fiziksel | — | physical, hardware |
...
| OBD-II Port | R155-5.5, R155-7.1, R155-4.2 | Bütünlük (I) |
...
| Debug Portları (JTAG/UART) | R155-7.4 | Bütünlük (I) |
